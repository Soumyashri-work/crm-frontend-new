...
/**
 * AddAdminModal.jsx — Simplified with auto-close on success
 * 
 * Features:
 * - Simple form for inviting admins
...
import { Shield, Mail, User, Building2, Loader2, RefreshCw, Check } from 'lucide-react';
    ...
    return (
      ...
      >
        <div className="modal-body">
          {/* Success banner with simple message */}
          <div className="modal-success-banner">
            <Check size={18} />
            <div>
              <div style={{ fontWeight: 600 }}>Invitation sent to your mail</div>
